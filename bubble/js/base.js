...
YATE.say = function () {
	return {
		alert: function (question) {
			...
			document.getElementById('alertbox_content').innerHTML = question + '<br style="clear:both" /> \
				<br /><a href="#" onclick="YATE.say.dismiss(); YATE.flow.restart();return false;"> \
				<img src="images/b_okay.png" alt="Okay" /></a>';
		},
		confirm: function (question) {
			YATE.flow.pause();
			document.getElementById('alertbox').style.display = 'block';
			document.getElementById('alertbox_content').innerHTML = question + '<br style="clear:both" /><br /> \
				<a href="#" onclick="YATE.say.dismiss(); YATE.flow.restart();return false;"> \
				<img src="images/b_yes.png" alt="Yes" /></a><a href="#" onclick="YATE.say.dismiss(); YATE.flow.resume(); return false;"> \
				<img src="images/b_no.png" alt="No" /></a>';
		},
		dismiss: function () {
	...
	return {
		...
		set: function (what) {
			...
			if (menu[what].active && what === 'game') {
				...
				YATE.say.confirm('<h1>New game</h1>Do you really want to<br />restart your game?');
				return;
			}
